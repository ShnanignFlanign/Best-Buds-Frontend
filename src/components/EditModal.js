      ...
      <>
        ...
        <Modal className="modal-xl pt-5 pr-5 pl-5" show={this.state.isOpen} onHide={this.closeModal}>
          ...
          <Container>
            <Row>
            <Col>
            <EditForm handleChange={this.props.handleChange} name={this.state.name} img={this.state.img} lightNeed={this.state.lightNeed} waterNeed={this.state.waterNeed} descritpion={this.state.description} classification={this.state.classification} id={this.state.id}/>
              </Col>
            </Row>
            </Container>
          </Modal.Body>
