  ...
  render(){
    return(
      <Container fluid fixed="bottom" className="custom-foot">
        ...
        <Col className="align-items-end"> <h4>&copy; Copyright 2022</h4></Col>
        <Col className="align-items-end">
          <h4>Developers</h4>
          <h5>Augustina Fin Scigliano  <i class="bi bi-github" style={{ fontSize: 20 }}></i> <i class="bi bi-linkedin" style={{ fontSize: 20 }}></i></h5>
